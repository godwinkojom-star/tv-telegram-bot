...
# ==========================================================
# TP/SL ratios: SL = 2.0x ATR, TP1 = 1.0x ATR, TP2 = 3.0x ATR, TP3 = 4.0x ATR
#
# TP1 intentionally sits close to entry (not a strict 1:2 risk-reward) -
# this is a deliberate choice: a close, easy-to-reach first target that
# hits more often, rather than a stretched target that hits less often.
# Stop loss stays wide (2.0x) regardless, so trades still have room to
# breathe past normal market noise. TP2/TP3 remain the bigger stretch
# targets for trades that keep running.
#
