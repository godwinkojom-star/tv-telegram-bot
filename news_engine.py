...
# app.py owns the process-wide logging configuration. Calling basicConfig()
# from this module would configure the root logger during import and could
# incorrectly apply a News Engine label/format to the rest of the bot.
