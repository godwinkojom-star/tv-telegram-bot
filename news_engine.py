...
_send_public_message = None
_send_public_photo = None
...
def configure_callbacks(
    send_public_message=None,
    send_public_photo=None,
    db_log_activity=None,
    get_db_connection=None,
    database_url=None,
):
    """Called once from app.py after its helpers exist."""
    global _send_public_message, _send_public_photo, _db_log_activity
    global _get_db_connection, _database_url
    _send_public_message = send_public_message
    _send_public_photo = send_public_photo
...
def _send_upcoming_alert(event: Dict[str, Any], key: str):
    try:
        ...
        sent = False
        if _send_public_photo:
            sent = _send_public_photo(img_bytes, caption=caption)
        if not sent and _send_public_message:
            _send_public_message(caption)
