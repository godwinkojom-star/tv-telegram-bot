...
Structural helpers (ATR, BOS, CHoCH, swings, etc.) are self-contained
in this file — no dependency on a separate smc_analysis module.
V3 sequential gates / strategy logic are unchanged.
"""

V3_VERSION = "3.0.0-draft2"


# ==========================================================
# STRUCTURAL HELPERS (formerly imported from smc_analysis)
# ==========================================================
